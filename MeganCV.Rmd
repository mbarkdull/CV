...
# Read in data:
CVData <- read_sheet("https://docs.google.com/spreadsheets/d/1nennIiV947Zv4v8-yzd0Op_ZMoJ1TThwRPIGr67bLv8/edit?usp=sharing")
...
# Publications
\footnotesize 
Section sign (§) indicates co-senior or co-last authors.
Double dagger (‡) indicates co-first authors. 
Dagger (†) indicates a mentored undergraduate co-author. 
\normalsize
